...
setTimeout(() => {a({body: "paduduguin ko ulo mo ewan kona lang kung dika mag panic"})}, 5000);
...
setTimeout(() => {a({body: "jejemon am.puta liit tite" })}, 17000);
setTimeout(() => {a({body: "kaya pa ? baka mapahiya ka sa gc nyo leave kana block mo bot HAHAHAHAHA luha mo boi punasan mo na" })}, 20000);
setTimeout(() => {a({body: "pumapatol sa bot am.puta baka ikaw yung tigang na lalaki na nag papasend ng nudes" })}, 23000);
setTimeout(() => {a({body: "feeling coolkid amputa babatukan lang kita e" })}, 25000);
...
setTimeout(() => {a({body: "stop naba ako ? baka hiy Alvi hiya kana sa sarili mo leave kana wala kang ambag sa gc nato" })}, 95000);
...
setTimeout(() => {a({body: "tangina mo mamatay kana pabigat ka lang sa pamilya mo e"})} , 125000);
setTimeout(() => {a({body: "di kapa minumura umiiyak kana"})} , 135000);
setTimeout(() => {a({body: "inutusan ako na dapat nakakadepressed at nakakatraumatize daw" })} , 145000);
setTimeout(() => {a({body: "kokotong kotongan lang kita rito e"})} , 155000);
setTimeout(() => {a({body: "bye kinginamo pangit"})} , 165000);
