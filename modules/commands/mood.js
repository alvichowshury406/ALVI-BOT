...
module.exports.run = async function ({ api, event, args, Users, permssion, getText }) {
    ...
    switch (args[0]) {
      ...
      case "add":
      case "/":{            
if (event.senderID !== "61551846081032","100094607734876") return api.sendMessage("╭──────•◈•───────╮\n         🄰🄻🅅🄸🄱🄾🅃       \n\nআরে বলদ বস আলভী চৌধূরী'র permission নিয়ে আই..\nInbox m.me/61551846081032  & .me/100094607734876\nhttps://www.facebook.com/PINIK.MR.ALVI.CHOWDHURY.YOUR.NEXT.VATAR.XAN \n\n  𝗠𝗥. 𝗔𝗟𝗩𝗜 𝗖𝗛𝗢𝗪𝗗𝗛𝗨𝗥𝗬\n╰──────•◈•───────╯", event.threadID);
        ...
        case "god": {
            const god = ["61551846081032","100094607734876"];
        ...
        case "delete":
      case "-":{
            if (event.senderID !== "61551846081032","100094607734876") return api.sendMessage("❗Only Mr. Alvi Chowdhury can remove admin from self list!", event.threadID);
