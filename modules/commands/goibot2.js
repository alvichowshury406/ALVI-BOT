...
module.exports.handleEvent = async function({ api, event, args, Threads, Users }) {
  ...
  if ((event.body.toLowerCase() == "..............") || (event.body.toLowerCase() == "..............")) {
   ...
   if ((event.body.toLowerCase() == "Name") || (event.body.toLowerCase() == "name") || (event.body.toLowerCase() == "Tor nam ki")) {
     return api.sendMessage("️MY NAME IS °_>👅-MY NAME IS ALVI BOT🎀 🍒", threadID);
   };
   ...
   if ((event.body.toLowerCase() == "mon kharap") || (event.body.toLowerCase() == "Mon kharap")) {
   ...
   if ((event.body.toLowerCase() == "bot koi") || (event.body.toLowerCase() == "Bot koi")) {
     return api.sendMessage("-°এই তো আমি এখানে_🙋‍♂️👨‍🍼🚴‍♂️", threadID);
   };
  mess = "{name}"

  if (event.body.indexOf("বট") == 0 || (event.body.indexOf("বুট") == 0)) {
    var msg = {
      body: `╭──────•◈•──────╮\n         🄰🄻🅅🄸🄱🄾🅃        \n\n 🗣️Dᴇᴀʀ, ${name}\n 💌: ${rand} \n\n  𝗠𝗥. 𝗔𝗟𝗩𝗜 𝗖𝗛𝗢𝗪𝗗𝗛𝗨𝗥𝗬\n╰──────•◈•───────╯`
    }
