...
module.exports.config = {
    ...
    version: "1.0.1",
    hasPermssion: 2,
    credits: "JOSHUA",//nakikifork ka na nga lang papalitan mopa ung credits tukmol ka 
 ...
 module.exports.onLoad = () => {
  console.log(chalk.bold.hex("#00c300").bold("╭──────•◈•───────╮\n    ALVI-BOT       \n\n============ SUCCESFULLY LOADED THE JOIN COMMAND ============\n\nMR. ALVI CHOWDHURY\n╰──────•◈•───────╯"));
  }
