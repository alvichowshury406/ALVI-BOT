      ...
      (async () => {
        ...
        for (const command of listCommand) {
          try {
            ...
            try {
              global.loading(`${cra(`LOADED`)} ${cb(config.name)} success`, "ALVI CMD LOAD");
            } catch (err) {
...
/* *
This bot was created by me (ALVI) and my brother Frogs. Do not steal my code. (つ ͡ ° ͜ʖ ͡° )つ ✄ ╰⋃╯
This file was modified by me (@ALVI). Do not steal my credits. (つ ͡ ° ͜ʖ ͡° )つ ✄ ╰⋃╯
* */
